...
$is_organizer = ($user_role == 'organizer' && $event['organizer_id'] == $user_id);
?>
...
<body>
        ...
        <main class="main-content">
            ...
            <div class="content-header">
                ...
                <div style="display: flex; gap: 10px;">
                    <?php if($is_organizer): ?>
                        <a href="../organizer/edit_event.php?id=<?php echo $event_id; ?>" class="btn btn-primary">✏️ Edit Event</a>
                    <?php endif; ?>
                    <a href="../common/home.php" class="btn btn-secondary">← Back</a>
                </div>
            </div>
            ...
            <div class="view-only-badge">
                👁️ You are viewing this event as <?php echo $is_organizer ? 'the organizer' : 'an ' . $user_role; ?>. 
                <?php echo $user_role == 'organizer' && !$is_organizer ? 'Only students can register for events.' : ''; ?>
            </div>
            <?php endif; ?>
            ...
            <div class="event-detail-container">
                ...
                <div class="event-main">
                    ...
                    <div class="social-actions-large">
                        ...
                        <button class="social-btn-large" onclick="shareEvent(<?php echo $event_id; ?>, '<?php echo addslashes($event['title']); ?>')">
                            <span>📤</span>
                            <span>Share</span>
                        </button>
                    </div>
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-top: 30px;">
                        ...
                        <div style="padding: 20px; background: #f7fafc; border-radius: 8px;">
                            <div style="font-size: 12px; color: #718096; margin-bottom: 5px;">🎭 EVENT TYPE</div>
                            <div style="font-weight: 600; color: #2d3748;">
                        ...
                        <div style="display: flex; align-items: center; gap: 15px;">
                            ...
                            <div>
                                <div style="font-weight: 600; font-size: 18px; margin-bottom: 5px;">
                                    ...
                                    <?php if($is_organizer): ?>
                                        <span style="background: rgba(255,255,255,0.3); padding: 4px 10px; border-radius: 12px; font-size: 12px; margin-left: 10px;">You</span>
                                    <?php endif; ?>
                                </div>
                ...
                <div class="event-sidebar">
                    ...
                    <?php if($is_organizer): ?>
                        ...
                        <a href="../organizer/edit_event.php?id=<?php echo $event_id; ?>" 
                           class="btn btn-secondary" 
                           style="width: 100%; text-align: center;">
                            ✏️ Edit Event
                        </a>
                    <?php elseif($user_role == 'admin'): ?>
                        <div style="padding: 15px; background: #e6e9fc; border-radius: 8px; text-align: center; margin-bottom: 10px;">
                            <div style="font-weight: 600; color: #667eea; margin-bottom: 5px;">⚙️ Admin View</div>
                            <div style="font-size: 13px; color: #4a5568;">You can manage this event from admin panel</div>
                        </div>
                    <?php else: ?>
                        <div style="padding: 15px; background: #fff3cd; border-radius: 8px; text-align: center; margin-bottom: 10px;">
                            <div style="font-weight: 600; color: #856404; margin-bottom: 5px;">👁️ View Only</div>
                            <div style="font-size: 13px; color: #856404;">Only students can register for events</div>
                        </div>
                    <?php endif; ?>
                    ...
                    <div style="margin-top: 20px; padding-top: 20px; border-top: 1px solid #e2e8f0;">
                        ...
                        <div style="display: flex; justify-content: space-between;">
                            <span style="color: #4a5568;">📊 Capacity Used</span>
                            <span style="font-weight: 600; color: #2d3748;">
                                <?php echo round(($event['registered_count'] / $event['max_participants']) * 100); ?>%
                            </span>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        function shareEvent(eventId, title) {
            const url = window.location.origin + '/campus-event-manager/common/view_event.php?id=' + eventId;
            if(navigator.share) {
                navigator.share({
                    title: title,
