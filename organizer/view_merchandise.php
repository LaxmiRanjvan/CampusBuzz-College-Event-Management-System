...
if($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['place_order'])) {
    ...
    if(!empty($sizes) && (empty($size_selected) || !in_array($size_selected, $sizes))) {
        ...
        $order_error = "You already have an active order for this item. Check My Orders for its status.";
    ...
    <main class="main-content">
        <div class="content-header">
            ...
            <div style="display:flex;gap:10px;">
                ...
                <?php // Note: my_merch.php must exist in each role's module folder (student/organizer/admin) ?>
        ...
        <?php if($order_success): ?>
            <div class="alert alert-success">
                ✅ Order placed successfully! Your payment is under review. Check <a href="my_merch.php">My Orders</a> for updates.
            </div>
        <?php endif; ?>
        <?php if($order_error): ?>
                    ...
                    if($b): ?>
                        <div class="status-banner <?php echo $b['class']; ?>">
                            ...
                            <div>
                                ...
                                <a href="my_merch.php" style="font-size:13px;color:#667eea;font-weight:600;display:inline-block;margin-top:6px;">View in My Orders →</a>
                            </div>
                        </div>
                    <?php endif; ?>
                <?php endif; ?>
